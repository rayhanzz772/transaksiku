  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 font-inter">
       <div className="container mx-auto p-6 bg-white rounded-xl shadow-lg">
        <h1 className="text-3xl font-bold text-gray-800 mb-8 text-center">Laporan Transaksi</h1>

        {/* Filtering Section */}
        <div className="bg-gray-50 p-6 rounded-lg shadow-inner mb-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
          ...
          <div>
            <label htmlFor="minAmount" className="block text-sm font-medium text-gray-700 mb-1">Min Nominal</label>
            <input
              type="number"
              id="minAmount"
              name="minAmount"
          ...
          <div>
            <label htmlFor="maxAmount" className="block text-sm font-medium text-gray-700 mb-1">Max Nominal</label>
            <input
              type="number"
              id="maxAmount"
              name="maxAmount"
          ...
          <div>
            <label htmlFor="recipient" className="block text-sm font-medium text-gray-700 mb-1">Rekening Tujuan</label>
            <select
              id="recipient"
              name="recipient"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold text-gray-700 mb-4 text-center">Tren Transaksi per Hari</h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            <h2 className="text-xl font-semibold text-gray-700 mb-4 text-center">Distribusi Status Transaksi</h2>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
          ...
          <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold text-gray-700 mb-4 text-center">Top Rekening Penerima (Berdasarkan Nominal)</h2>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart
