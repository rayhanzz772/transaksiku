...
const Profile = () => {
  ...
  return (
        <div
      className={`w-full ${isDarkMode ? "bg-gray-900 text-gray-100" : "bg-gray-100 text-gray-900"} font-inter transition-colors duration-300 p-4`}
    >
      <div
        className={`container mx-auto p-6 ${isDarkMode ? "bg-gray-800 text-gray-100" : "bg-white text-gray-900"} rounded-xl shadow-lg`}
      >
        <h1 className="text-3xl font-bold text-grey-400 dark:text-white mb-8 text-center">Pengaturan & Profil</h1>

                {/* Profile Management Section */}
        <div
          className={`mb-10 p-6 ${isDarkMode ? "bg-gray-700 text-gray-100" : "bg-gray-50 text-gray-900"} rounded-lg shadow-inner`}
        >
        ...
        <div
          className={`mb-10 p-6 ${isDarkMode ? "bg-gray-700 text-gray-100" : "bg-gray-50 text-gray-900"} rounded-lg shadow-inner`}
        >
          <h2 className={`text-2xl font-semibold mb-5 ${isDarkMode ? "text-blue-300" : "text-blue-700"}`}>Pengaturan Aplikasi</h2>
